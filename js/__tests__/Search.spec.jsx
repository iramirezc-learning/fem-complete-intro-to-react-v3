...
test('Searh should render correct amount of shows based on a search term - without redux', () => {
...
test('Searh should render correct amount of shows based on a search term - with redux', () => {
  const searchWord = 'black';
